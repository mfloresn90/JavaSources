...
public class Jugador extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      PruebaDTO2 jk = new PruebaDTO2();
      jk.setEmail(email.getText());
      jk.setNombre(nombre.getText());
      jk.setPassword(pass.getText());

      PruebaDao2 jp = new PruebaDao2();
       JOptionPane.showMessageDialog(null, jp.create(jk));
