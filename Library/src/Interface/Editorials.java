...
import modelo.facade.EdiService;
 ...
 */
public class Editorials extends javax.swing.JInternalFrame {
    ...
    public void showEditorials() {
        ...
        try {
            ...
            ResultSet rst = set.executeQuery("SELECT * FROM editorial");
            while (rst.next()) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Panel de Editoriales");
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        ...
        MenuStart.editorialSubMenu.setEnabled(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        arriba, llenando los valores que se establecieron en EditorialDto y
        EditorialDao*/
        editorialData = new EdiService();
        editorialDTO = new EditorialDto();
        editorialDTO.setEditorial(jTextField1.getText());
        try {
            editorialData.createEditorial(editorialDTO);
            resetStatus();
    ...
    private void categoryTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_categoryTableMouseClicked
        /*Con esto obtenemos el id del registro y activamos
        los botones de actualizar, eliminar y cancelar*/
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        editorialData = new EdiService();
        editorialDTO = new EditorialDto();
        editorialDTO.setEditorialId(id);
        editorialDTO.setEditorial(jTextField1.getText());
        try {
            editorialData.updateEditorial(editorialDTO);
            resetStatus();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        editorialDTO.setEditorialId(id);
        try {
            editorialData.deleteEditorial(editorialDTO);
            resetStatus();
