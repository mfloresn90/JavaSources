...
public class PropManager
{
  ...
  { System.out.println("Loading model file: models/" + fnm);
	...
	try {
      if (ext.equals("obj")) {   // the file is a wavefront model
        ...
        s = of.load("AugReality/models/"+fnm);
      }
      else {  // use Portfolio loader for other models
        ModelLoader modelLoader = new ModelLoader();
	    s = modelLoader.load("AugReality/models/"+fnm);   // handles many types of file
	  }
    }
	catch (Exception e) {
  ...
  */
  { 
    String coordFile = "AugReality/models/" + getName(fnm) + "Coords.txt";
    try {
  ...
  */
  ...
  {
    String coordFnm = "AugReality/models/" + getName(filename) + "Coords.txt";
    try {
